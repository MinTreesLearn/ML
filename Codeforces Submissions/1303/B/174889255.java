...
public class B_National_Project {
    ...
    public static void solve(FastReader f, PrintWriter out) {
        ...
        // long goodRoad = (n/total)*g + min(g, n%total);
        // long badRoad = (n/total)*b + max(0, n%total - g);
        ...
        // long reqGoodRoad = (badRoad-goodRoad+1)/2;

        // long reqExtraDay = (reqGoodRoad/g)*total + reqGoodRoad%g;
        // if(reqGoodRoad%g == 0) {
        //     reqExtraDay -= b;
        // }

        // out.println(n + reqExtraDay);

        long req = (n+1)/2;
        long ans = (req/g)*total + req%g;
        if(req%g == 0) {
            ans -= b;
        }

        out.println(max(n, ans));
    }
