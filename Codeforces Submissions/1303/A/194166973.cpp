...
//    // go right
//    if (j < n - 1) {
//        solve(sm + arr[i][j + 1], i, j + 1);
//    }else{
//        solve(sm + arr[i][0], i, 0);
//    }
//
//    // go down
//    if (i < n - 1) {
//        solve(sm + arr[i + 1][j], i + 1, j);
//    }else{
//        solve(sm + arr[0][j], 0, j);
//    }
//
//    res = max(res, sm);
//
...
int main() {
    ...
    while (t--) {
        ...
        cin >> str;
        int cnt = 0;
        for (int i = str.find('1'); i < str.rfind('1'); i++) {
            if (str[i] == '0')
                cnt++;
        }
        cout << cnt << el;
