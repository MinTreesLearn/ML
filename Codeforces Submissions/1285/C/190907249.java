...
public class Main
{
    ...
    public static void main(String args[]) throws IOException
    {
        ...
        // for(int j=4;j<=x;j+=2)
        // spf[j]=2;
        // for(long j=3;(long)j*(long)j<(long)x;j++)
        // {
        //     if(spf[(int)j]==j)
        //     {
        //         for(long k=j*j;k<(long)x;k+=j)
        //         {
        //             if(spf[(int)k]==k)
        //             spf[(int)k]=(int)j;
        //         }
        ...
        {
            long x=sc.nextLong();
            ArrayList<Long> factors=getFactors(x);
            factors.add(0,1L);
            factors.add(x);
            long ans1=1;
            long ans2=x;
            ...
            {
                long temp1=factors.get(j);
                long temp2=x/temp1;
                if(lcm(temp1,temp2)==x&&Math.max(temp1,temp2)<=Math.max(ans1,ans2))
                {
                    ans1=temp1;
                    ans2=temp2;
                }
