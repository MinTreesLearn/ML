...
//		 System.out.println(factors);
		 ...
		 for(long h:ver) {
			 ...
			 long val = 0;
			 for(long v:hor) {
				 long num = fnc(h, v, k, factors);
				  val += num;
				 ans += num ;
//				 System.out.println(h+" , "+v +" - "+fnc(h, v, k, factors));
			 }
			 map.put(h, val);
		 }
		 System.out.println(ans);
	 }
	 static long fnc(long n , long m, long k , ArrayList<Long> factors ) {
		 long ans = 0;
		 for(long r:factors) {
			 long c=  k/r;
			 if(r > n) break;
