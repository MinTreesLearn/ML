...
public class b {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int tc = 1;
        int[] nk = readArray(3,0,0);
        int[] row = readArray(nk[0],0,0);
        int[] col =readArray(nk[1],0,0)  ;
        ...
        for(int i=1;i*i<=k;i++){
            ...
            long x2 =rows(j,col);
           ans+=(x1*x2);
          //System.out.println(i+" "+j +" "+x1+" "+x2+" i*j ");
           //j*i
          if(j==i){
          	continue;
          }
           x1 = rows(j,row);
            x2 =rows(i,col);
      //System.out.println(j+" "+i +" "+x1+" "+x2+" j*i ");
    ...
    public static long rows(int cons,int[] row){
    	long ans=0;
            int sum=0;
