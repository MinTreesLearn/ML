...
public class Main
{
    ...
    static class InputReader {
        ...
        private int skip() { int b; while((b = read()) != -1 && isSpaceChar(b)); return b; }
    ...
    static class CP {
        ...
        static int upper_Bound(int a[], long x) {
            long l = 0, h = a.length-1, mid = 0, ans = -1;
            while (l <= h) {
                mid = (l + h) /2;
                if (a[(int) mid] > x) {
                    ans = mid;
