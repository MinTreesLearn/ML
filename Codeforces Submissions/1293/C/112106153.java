...
// static int mod= 1000000007 ;
 ...
 public static void help(int v ,Set<Integer> s )
 {
     if(s.contains(v) || s.contains(v+1) || s.contains(v-1))
     {
         set.add(v) ;return ;
     }
...
int n= scn.nextInt() ;int q= scn.nextInt() ;

int r1 =1 ;int r2 =1 ;// 1- all ground ,0 - not all ground

 
Set<Integer> arr[] = new HashSet[2];

arr[0] = new HashSet<>() ;arr[1] = new HashSet<>() ;
...
while(q-- > 0)
{
    ...
    if(l ==1)
    {
        ...
        if(arr[0].contains(r))
        {
            ...
            if(arr[1].contains(r))arr[1].remove(r) ;
            else arr[1].add(r) ;
            
            if(arr[0].contains(r))help(r,arr[1]) ;
            
            if(arr[0].contains(r-1))help(r-1,arr[1]) ;
            ...
            if(arr[0].contains(r+1))help(r+1,arr[1]) ;
              ...
              if(arr[0] .size() == 0 || arr[1].size() == 0 || set.size() == 0 )
            {
                String ans  = "YES" ;out.println(ans) ;
            }
            else{
                String ans  ="NO" ;out.println(ans) ;
            }
