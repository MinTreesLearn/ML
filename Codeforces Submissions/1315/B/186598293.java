...
public class cf {
    ...
    public static class pairAl {
        int n;
        ArrayList<Integer> al;

        public pairAl(int n, ArrayList<Integer> al) {
            this.n = n;
            this.al = al;
        }
    }
    ...
    public static int help(String a, String b, int x, int visit[][]) {
        int id = 0;
        int cur = 0;
        int n = a.length();
        while (id < n) {
            if (id == n - 1) {
                if (a.charAt(id) == 'B' && visit[0][id] == 0) {
                    cur++;
                }
                if (b.charAt(id) == 'B' && visit[1][id] == 0) {
                    cur++;
                }
                break;
            }
            if (x == 0) {
                ...
                if (b.charAt(id) == 'B' && visit[1][id] == 0) {
                    x = 1;
                } else if (a.charAt(id + 1) == 'B' && visit[0][id + 1] == 0) {
                    x = 0;
                    id++;
                } else {
                    break;
                ...
                if (a.charAt(id) == 'B' && visit[0][id] == 0) {
                    x = 0;
                } else if (b.charAt(id + 1) == 'B' && visit[1][id + 1] == 0) {
                    x = 1;
                    id++;
                } else {
                    break;
    ...
    public static void solve(FastReader sc, PrintWriter w, StringBuilder sb) throws Exception {
        ...
        for (int i = 0; i < s.length(); i++) {
            if (s.charAt(i) != prev && i + 1 != s.length()) {
                al.add(i);
