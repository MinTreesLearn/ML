...
// lazy prop sgt impl partly from benq's https://codeforces.com/contest/1320/submission/72172966
// sgt specialized for range sum upd and range max qry

public class cf1320c {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i = 0; i < n; ++i) {
            while(curmon < p && mon[curmon][0] < a[i][0]) {
                ...
                if(ind != null) {
                    // prln(mon[curmon][1], ind, find.get(ind));
                    upd(find.get(ind), mx - 1, mon[curmon][2], 1, 0, mx - 1);
                }
                ++curmon;
            }
            // prln(-a[i][1], qry(0, mx - 1, 1, 0, m - 1));
