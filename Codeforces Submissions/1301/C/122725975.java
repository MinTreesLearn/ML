		 ...
		 outer:while(tt-->0)
			    {
			    	...
			    	{
			    		long todivide=m+1;
			    		long num=(n-m)/todivide;
			    		long mod=(n-m)%todivide;
			    		long first=(((num+1)*(num+2))/2)*mod;
			    		long second=(m+1)-mod;
			    		second=second*(num*(num+1)/2);
			    		out.println((n*(n+1)/2)-(first+second));
			    	}
